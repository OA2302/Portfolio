...
const Form = () => {
  ...
  const onSubmit = (data, e) => {
    ...
    fetch(`${Alert.baseUrl}/user/register`, {
      method: "POST",
      headers: {
  ...
  return (
    <div
      className={`${Alert.container} container-fluid d-flex align-items-center justify-content-center`}
    >
      <div className={Alert.registrationFormContainer}>
        {message && (
          <div
        ...
        <fieldset className="border p-3 rounded">
          <legend
            className={`${Alert.registrationFormLegend} border rounded p-1 text-center`}
          >
            Registration Form
          </legend>
          <form onSubmit={handleSubmit(onSubmit)} noValidate autoComplete="off">
            <div className="form-group">
               ...
               */}
              {errors.email && (
                <span className={`${Alert.errorMessage} mandatory`}>
